...
import { getPrizePool2Info, getWinRecords, getCurentArena, getTopBuyerTimeThreshold } from '@/hooks/nono';
...
function Arena() {
    ...
    sync2 = async () => {
        ...
        if (time <= 0) {
            ...
            setCountdown(`${minutes < 10 ? '0' + minutes : minutes}:${seconds < 10 ? '0' + seconds : seconds}`);
        }
                ...
                <RightPanel>
                    <DashboardBox>
                        ...
                        <Amount>
                            ...
                            >
                                {ethers.utils.formatEther(currentTopBuyer.amount).replace(/\.0$/, '')}
                                &ensp;ETH
                            </span>
                        </Amount>
                    </DashboardBox>
